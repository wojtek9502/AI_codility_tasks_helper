...
WebUI is created with using Streamlit: https://streamlit.io/  
More about Microsoft Autogen: https://microsoft.github.io/autogen/docs/Getting-Started/ 

Example task: https://app.codility.com/programmers/lessons/15-caterpillar_method/count_triangles/
![img.png](screen1.png)
...
## Important
```
This project execute code created by AI. When you run this project from source, set USE_DOCKER_CODE_EXECUTOR env as 1, 
to run code generated by AI inside separated docker container (install docker first). 
You can set this value as 0 to run AI generated code on your local machine at your own risk

When you run this project as docker container, there is no point to create another one.
In this case set USE_DOCKER_CODE_EXECUTOR as 0.
```
